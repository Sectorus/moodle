...
// 		        get_string('reportwhattoinclude', 'quiz'));
		...
		$mform->addElement('select', 'folders', 'Verzeichnishierarchie', array(
		        'questionwise'    => 'Nach Frage ordnen',
		        'attemptwise'     => 'Nach Versuchen ordnen',
		));

// 		$mform->addElement('selectyesno', 'textresponse',
// 		        'Include text response');

		$mform->addElement('select', 'textresponse', 'Download beinhaltet Textantwort ', array(
		        '1'   => 'Ja',
		        '0'   => 'Nein',
		));

		$mform->addElement('select', 'questiontext', 'Download beinhaltet Fragetext', array(
		        '1'   => 'Ja',
		        '0'   => 'Nein',
		));
